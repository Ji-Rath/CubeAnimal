 ...
 */
UCLASS()
class CUBEANIMAL_API UAttributeSetBase : public UAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	ATTRIBUTE_ACCESSORS(UAttributeSetBase, XPBounty)
	...
	ATTRIBUTE_ACCESSORS(UAttributeSetBase, GoldBounty)
